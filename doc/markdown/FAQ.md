...
- Q: _Why are the Python bindings not built?_
  ...
  __Long answer__: the bindings are automatically generated by a script. You may not have all dependencies correctly installed (or detected by cmake). Check the [Installation](installation.html) page for details on installing dependencies.
