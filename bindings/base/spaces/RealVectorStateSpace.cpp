...
void ompl::binding::base::initSpaces_RealVectorStateSpace(nb::module_& m)
{
    ...
    nb::class_<ompl::base::RealVectorStateSpace, ompl::base::StateSpace>(m, "RealVectorStateSpace", 
        "A state space representing R^n with L2 norm distance")
        ...
        .def("addDimension", nb::overload_cast<const std::string&, double, double>(&ompl::base::RealVectorStateSpace::addDimension),
        ...
        .def("printSettings", [](const ompl::base::RealVectorStateSpace& space) {
