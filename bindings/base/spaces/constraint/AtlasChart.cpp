...
void ompl::binding::base::initSpacesConstraint_AtlasChart(nb::module_ &m) {
    ...
    nb::class_<ob::AtlasChart>(m, "AtlasChart")
        ...
        .def(nb::init<const ob::AtlasStateSpace*, const ob::AtlasStateSpace::StateType*>(),
             nb::arg("atlas"), nb::arg("state"),
             "Construct a chart centered at a given state in the AtlasStateSpace.")
        // Destructor is implicit

        // Clear all polytope halfspaces
        .def("clear", &ob::AtlasChart::clear,
             "Remove all halfspaces (i.e. reset the chart region).")

        // Accessors
        .def("getOrigin",
             &ob::AtlasChart::getOrigin,
             nb::rv_policy::reference_internal,
             "Return the StateType at the center of this chart.")
        .def("getAmbientDimension",
             &ob::AtlasChart::getAmbientDimension,
             "Dimension of the ambient space.")
        .def("getManifoldDimension",
             &ob::AtlasChart::getManifoldDimension,
        ...
        .def("psi",
             ...
             nb::arg("u"),
             "Ambient-to-chart projection ψ(x) → (success, local coords).")
        ...
        .def("getNeighborCount",
             &ob::AtlasChart::getNeighborCount,
             "Number of neighboring charts / polytope facets.")

        // Is this chart a frontier?
        .def("estimateIsFrontier",
             &ob::AtlasChart::estimateIsFrontier,
             "Return True if this chart lies on the boundary of the manifold.")

        // Static helper: construct halfspaces between two charts
        .def_static("generateHalfspace",
                    &ob::AtlasChart::generateHalfspace,
                    nb::arg("c1"), nb::arg("c2"),
                    "Compute and link the Halfspace separating c1 and c2.");

    // No additional free-functions needed.
}
