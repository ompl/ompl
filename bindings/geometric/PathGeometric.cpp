...
void ompl::binding::geometric::init_PathGeometric(nb::module_ &m)
{
    nb::class_<ompl::geometric::PathGeometric, ompl::base::Path>(m, "PathGeometric")
        ...
        .def(nb::init<const ompl::geometric::PathGeometric &>(),
             "Copy constructor")
        .def(nb::init<const ompl::base::SpaceInformationPtr &, const ompl::base::State *>(),
             nb::arg("si"), nb::arg("state"),
             "Construct a PathGeometric from a single state")
        .def(nb::init<const ompl::base::SpaceInformationPtr &, const ompl::base::State *, const ompl::base::State *>(),
             ...
             "Construct a PathGeometric from two states")
        .def(nb::init<const ompl::base::SpaceInformationPtr &, std::vector<const ompl::base::State *> &>(),
             nb::arg("si"), nb::arg("states"),
             "Construct a PathGeometric from a list of states")
        
        // Assignment operator
        .def("assign", 
             [](ompl::geometric::PathGeometric &self, const ompl::geometric::PathGeometric &other) -> ompl::geometric::PathGeometric& {
                 self = other;
                 return self;
             }, "Assign another PathGeometric to this one")
        
        // Cost, length, and check.
        .def("cost", &ompl::geometric::PathGeometric::cost,
        ...
        .def("smoothness", &ompl::geometric::PathGeometric::smoothness,
             "Return the smoothness measure of the path")
        .def("clearance", &ompl::geometric::PathGeometric::clearance,
             "Return the clearance of the path")
        ...
        .def("interpolate", nb::overload_cast<unsigned int>(&ompl::geometric::PathGeometric::interpolate),
             nb::arg("count"),
             "Interpolate the path by inserting 'count' new states")
        ...
        .def("overlay", &ompl::geometric::PathGeometric::overlay,
             "Overlay another path onto this path", nb::arg("over"), nb::arg("startIndex") = 0)
        
        // Append, prepend, and keeping parts.
        .def("append", nb::overload_cast<const ompl::base::State *>(&ompl::geometric::PathGeometric::append),
             nb::arg("state"),
             "Append a state to the path")
        .def("append", nb::overload_cast<const ompl::geometric::PathGeometric &>(&ompl::geometric::PathGeometric::append),
             nb::arg("path"),
             "Append another path to this path")
        .def("prepend", &ompl::geometric::PathGeometric::prepend,
             "Prepend a state to the path", nb::arg("state"))
        ...
        .def("clear", &ompl::geometric::PathGeometric::clear,
             "Clear all states from the path");
}