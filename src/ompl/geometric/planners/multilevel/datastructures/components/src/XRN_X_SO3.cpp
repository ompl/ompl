...
ompl::geometric::BundleSpaceComponent_SO3RN_SO3::BundleSpaceComponent_SO3RN_SO3(base::StateSpacePtr BundleSpace,
                                                                                base::StateSpacePtr BaseSpace)
  : BaseT(BundleSpace, BaseSpace)
{
}

void ompl::geometric::BundleSpaceComponent_SO3RN_SO3::projectBase(const ompl::base::State *xBundle,
...
void ompl::geometric::BundleSpaceComponent_SO3RN_SO3::liftState(const ompl::base::State *xBase,
