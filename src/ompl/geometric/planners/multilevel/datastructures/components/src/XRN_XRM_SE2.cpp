...
ompl::geometric::BundleSpaceComponent_SE2RN_SE2RM::BundleSpaceComponent_SE2RN_SE2RM(base::StateSpacePtr BundleSpace,
                                                                                    base::StateSpacePtr BaseSpace)
  : BaseT(BundleSpace, BaseSpace)
{
}

void ompl::geometric::BundleSpaceComponent_SE2RN_SE2RM::projectBase(const ompl::base::State *xBundle,
...
void ompl::geometric::BundleSpaceComponent_SE2RN_SE2RM::liftState(const ompl::base::State *xBase,
