...
ompl::geometric::BundleSpaceComponent_SE3_R3::BundleSpaceComponent_SE3_R3(base::StateSpacePtr BundleSpace,
                                                                          base::StateSpacePtr BaseSpace)
  : BaseT(BundleSpace, BaseSpace)
{
}

void ompl::geometric::BundleSpaceComponent_SE3_R3::projectFiber(const ompl::base::State *xBundle,
...
void ompl::geometric::BundleSpaceComponent_SE3_R3::projectBase(const ompl::base::State *xBundle,
...
void ompl::geometric::BundleSpaceComponent_SE3_R3::liftState(const ompl::base::State *xBase,
