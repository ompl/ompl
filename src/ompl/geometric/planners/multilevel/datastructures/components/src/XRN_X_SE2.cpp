...
ompl::geometric::BundleSpaceComponent_SE2RN_SE2::BundleSpaceComponent_SE2RN_SE2(base::StateSpacePtr BundleSpace,
                                                                                base::StateSpacePtr BaseSpace)
  : BaseT(BundleSpace, BaseSpace)
{
}

void ompl::geometric::BundleSpaceComponent_SE2RN_SE2::projectBase(const ompl::base::State *xBundle,
...
void ompl::geometric::BundleSpaceComponent_SE2RN_SE2::liftState(const ompl::base::State *xBase,
