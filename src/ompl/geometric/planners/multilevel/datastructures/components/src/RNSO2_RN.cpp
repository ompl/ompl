...
ompl::geometric::BundleSpaceComponent_RNSO2_RN::BundleSpaceComponent_RNSO2_RN(
...
void ompl::geometric::BundleSpaceComponent_RNSO2_RN::projectFiber(
...
void ompl::geometric::BundleSpaceComponent_RNSO2_RN::projectBase(
    const ompl::base::State *xBundle,
...
void ompl::geometric::BundleSpaceComponent_RNSO2_RN::liftState(
