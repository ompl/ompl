#ifndef OMPL_GEOMETRIC_PLANNERS_BUNDLESPACE_DATASTRUCTURES_GRAPHSAMPLER_EXPONENTIAL_DECAY__
#define OMPL_GEOMETRIC_PLANNERS_BUNDLESPACE_DATASTRUCTURES_GRAPHSAMPLER_EXPONENTIAL_DECAY__
