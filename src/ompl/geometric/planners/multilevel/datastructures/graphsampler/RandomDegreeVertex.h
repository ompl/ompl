#ifndef OMPL_GEOMETRIC_PLANNERS_BUNDLESPACE_DATASTRUCTURES_GRAPHSAMPLER_RANDOM_DEGREEVERTEX_
#define OMPL_GEOMETRIC_PLANNERS_BUNDLESPACE_DATASTRUCTURES_GRAPHSAMPLER_RANDOM_DEGREEVERTEX_
