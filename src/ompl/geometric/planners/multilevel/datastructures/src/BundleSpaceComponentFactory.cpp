...
ompl::geometric::BundleSpaceComponentFactory::MakeBundleSpaceComponents(base::SpaceInformationPtr Bundle)
{
...
ompl::geometric::BundleSpaceComponentFactory::MakeBundleSpaceComponent(const base::StateSpacePtr Bundle)
{
    return MakeBundleSpaceComponent(Bundle, nullptr, false);
}

ompl::geometric::BundleSpaceComponentPtr ompl::geometric::BundleSpaceComponentFactory::MakeBundleSpaceComponent(
...
ompl::geometric::BundleSpaceComponentFactory::identifyBundleSpaceComponentType(const base::StateSpacePtr Bundle,
...
bool ompl::geometric::BundleSpaceComponentFactory::isMapping_Identity(const base::StateSpacePtr Bundle,
                                                                      const base::StateSpacePtr Base)
{
...
bool ompl::geometric::BundleSpaceComponentFactory::isMapping_RN_to_RM(const base::StateSpacePtr Bundle,
                                                                      const base::StateSpacePtr Base)
{
    if (Bundle->isCompound())
        return false;
...
bool ompl::geometric::BundleSpaceComponentFactory::isMapping_SE3_to_R3(const base::StateSpacePtr Bundle,
                                                                       const base::StateSpacePtr Base)
{
    if (!Bundle->isCompound())
        return false;
...
bool ompl::geometric::BundleSpaceComponentFactory::isMapping_SE3RN_to_R3(const base::StateSpacePtr Bundle,
                                                                         const base::StateSpacePtr Base)
{
    if (!Bundle->isCompound())
        return false;
...
bool ompl::geometric::BundleSpaceComponentFactory::isMapping_SE2_to_R2(const base::StateSpacePtr Bundle,
                                                                       const base::StateSpacePtr Base)
{
    if (!Bundle->isCompound())
        return false;
...
bool ompl::geometric::BundleSpaceComponentFactory::isMapping_RNSO2_to_RN(const base::StateSpacePtr Bundle,
                                                                         const base::StateSpacePtr Base)
{
    if (!Bundle->isCompound())
        return false;
...
bool ompl::geometric::BundleSpaceComponentFactory::isMapping_SE2RN_to_R2(const base::StateSpacePtr Bundle,
                                                                         const base::StateSpacePtr Base)
{
    if (!Bundle->isCompound())
        return false;
...
bool ompl::geometric::BundleSpaceComponentFactory::isMapping_SE2RN_to_SE2(const base::StateSpacePtr Bundle,
                                                                          const base::StateSpacePtr Base)
{
    return isMapping_XRN_to_X(Bundle, Base, base::STATE_SPACE_SE2);
}

bool ompl::geometric::BundleSpaceComponentFactory::isMapping_SE3RN_to_SE3(const base::StateSpacePtr Bundle,
                                                                          const base::StateSpacePtr Base)
{
    return isMapping_XRN_to_X(Bundle, Base, base::STATE_SPACE_SE3);
}

bool ompl::geometric::BundleSpaceComponentFactory::isMapping_SO2RN_to_SO2(const base::StateSpacePtr Bundle,
                                                                          const base::StateSpacePtr Base)
{
    return isMapping_XRN_to_X(Bundle, Base, base::STATE_SPACE_SO2);
}

bool ompl::geometric::BundleSpaceComponentFactory::isMapping_SO3RN_to_SO3(const base::StateSpacePtr Bundle,
                                                                          const base::StateSpacePtr Base)
{
    return isMapping_XRN_to_X(Bundle, Base, base::STATE_SPACE_SO3);
}

bool ompl::geometric::BundleSpaceComponentFactory::isMapping_SE2RN_to_SE2RM(const base::StateSpacePtr Bundle,
                                                                            const base::StateSpacePtr Base)
{
    return isMapping_XRN_to_XRM(Bundle, Base, base::STATE_SPACE_SE2);
}

bool ompl::geometric::BundleSpaceComponentFactory::isMapping_SE3RN_to_SE3RM(const base::StateSpacePtr Bundle,
                                                                            const base::StateSpacePtr Base)
{
    return isMapping_XRN_to_XRM(Bundle, Base, base::STATE_SPACE_SE3);
}

bool ompl::geometric::BundleSpaceComponentFactory::isMapping_SO2RN_to_SO2RM(const base::StateSpacePtr Bundle,
                                                                            const base::StateSpacePtr Base)
{
    return isMapping_XRN_to_XRM(Bundle, Base, base::STATE_SPACE_SO2);
}

bool ompl::geometric::BundleSpaceComponentFactory::isMapping_SO3RN_to_SO3RM(const base::StateSpacePtr Bundle,
                                                                            const base::StateSpacePtr Base)
{
    return isMapping_XRN_to_XRM(Bundle, Base, base::STATE_SPACE_SO3);
}

bool ompl::geometric::BundleSpaceComponentFactory::isMapping_XRN_to_X(const base::StateSpacePtr Bundle,
                                                                      const base::StateSpacePtr Base,
...
bool ompl::geometric::BundleSpaceComponentFactory::isMapping_XRN_to_XRM(const base::StateSpacePtr Bundle,
                                                                        const base::StateSpacePtr Base,
                                                                        const base::StateSpaceType type)
{
    if (!Bundle->isCompound())
...
bool ompl::geometric::BundleSpaceComponentFactory::isMapping_EmptyProjection(const base::StateSpacePtr,
                                                                             const base::StateSpacePtr Base)
{
