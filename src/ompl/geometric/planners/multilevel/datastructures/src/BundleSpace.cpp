...
unsigned int ompl::geometric::BundleSpace::interpolateAlongBasePath(const std::vector<base::State *> basePath,
...
void ompl::geometric::BundleSpace::liftState(const base::State *xBase, const base::State *xFiber,
