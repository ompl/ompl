...
ompl::geometric::BundleSpaceComponent_SE3RN_R3::BundleSpaceComponent_SE3RN_R3(
...
void ompl::geometric::BundleSpaceComponent_SE3RN_R3::projectFiber(
...
void ompl::geometric::BundleSpaceComponent_SE3RN_R3::projectBase(
    const ompl::base::State *xBundle,
...
void ompl::geometric::BundleSpaceComponent_SE3RN_R3::mergeStates(
