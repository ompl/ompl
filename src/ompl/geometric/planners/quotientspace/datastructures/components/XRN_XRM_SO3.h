#ifndef OMPL_GEOMETRIC_PLANNERS_BUNDLESPACE_BUNDLE_COMPONENT_SO3RN_SO3RM__
#define OMPL_GEOMETRIC_PLANNERS_BUNDLESPACE_BUNDLE_COMPONENT_SO3RN_SO3RM__
...
namespace ompl
{
    namespace geometric
    {
        class BundleSpaceComponent_SO3RN_SO3RM: public BundleSpaceComponent_XRN_XRM
        {
          ...
          public:
            BundleSpaceComponent_SO3RN_SO3RM(
