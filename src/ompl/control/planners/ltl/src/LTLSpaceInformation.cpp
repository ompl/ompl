...
void oc::LTLSpaceInformation::extendPropagator(const oc::SpaceInformationPtr &oldsi)
{
    ...
    {
    public:
        LTLStatePropagator(oc::LTLSpaceInformation *ltlsi, const oc::ProductGraphPtr &prod,
...
void oc::LTLSpaceInformation::extendValidityChecker(const oc::SpaceInformationPtr &oldsi)
{
    ...
    {
    public:
        LTLStateValidityChecker(oc::LTLSpaceInformation *ltlsi, const oc::ProductGraphPtr &prod,
