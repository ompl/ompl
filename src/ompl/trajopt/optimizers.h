...
namespace sco
{
    ...
    public:
        ...
        double improve_ratio_threshold_{.25},  // minimum ratio true_improve/approx_improve to accept step
            ...
            maxIter_{40},
            // if improvement (exact / approximate) is less than improve_ratio_threshold, shrink trust region by this
            // ratio
            trust_shrink_ratio_{.1},
            // if improvement (exact / approximate) is greater than or equal to improve_ratio_threshold, expand trust
            // region by this ratio
            trust_expand_ratio_{1.5}, cnt_tolerance_{1e-4},  // after convergence of penalty subproblem, if constraint
                                                             // violation is less than this, we're done
