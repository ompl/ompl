...
macro(find_boost_python)
    if (PYTHON_FOUND)
        ...
        if (NOT Boost_PYTHON_LIBRARY)
          message(SEND_ERROR "Failed to find matching Boost.Python library! Python bindings probably won't work.")
        endif()
    endif()
...
macro(find_boost_numpy)
    if (PYTHON_FOUND)
        ...
        if (NOT Boost_NUMPY_LIBRARY)
          message(SEND_ERROR "Failed to find matching Boost.Numpy library! Python bindings probably won't work.")
        endif()
    endif()
