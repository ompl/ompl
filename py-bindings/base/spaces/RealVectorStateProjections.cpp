...
void ompl::binding::base::initSpaces_RealVectorStateProjections(nb::module_ &m)
{
    ...
    nb::class_<ob::RealVectorLinearProjectionEvaluator, ob::ProjectionEvaluator>(m, "RealVectorLinearProjectionEvaluato"
                                                                                    "r")
        ...
        .def(nb::init<const ob::StateSpacePtr &, const std::vector<double> &, const ob::ProjectionMatrix::Matrix &>(),
             nb::arg("space"), nb::arg("cellSizes"), nb::arg("projection"))
        .def(nb::init<const ob::StateSpace *, const ob::ProjectionMatrix::Matrix &>(), nb::arg("space"),
             nb::arg("projection"))
        .def(nb::init<const ob::StateSpacePtr &, const ob::ProjectionMatrix::Matrix &>(), nb::arg("space"),
             nb::arg("projection"))
    ...
    nb::class_<ob::RealVectorRandomLinearProjectionEvaluator, ob::RealVectorLinearProjectionEvaluator>(m, "RealVectorRa"
                                                                                                          "ndomLinearPr"
                                                                                                          "ojectionEval"
                                                                                                          "uator")
        .def(nb::init<const ob::StateSpace *, const std::vector<double> &>(), nb::arg("space"), nb::arg("cellSizes"))
        .def(nb::init<const ob::StateSpacePtr &, const std::vector<double> &>(), nb::arg("space"), nb::arg("cellSizes"))
        .def(nb::init<const ob::StateSpace *, unsigned int>(), nb::arg("space"), nb::arg("dim"))
        .def(nb::init<const ob::StateSpacePtr &, unsigned int>(), nb::arg("space"), nb::arg("dim"));

    // RealVectorOrthogonalProjectionEvaluator
    // TODO [ob::RealVectorOrthogonalProjectionEvaluator][TEST]
    nb::class_<ob::RealVectorOrthogonalProjectionEvaluator, ob::ProjectionEvaluator>(m, "RealVectorOrthogonalProjection"
                                                                                        "Evaluator")
        ...
        .def(nb::init<const ob::StateSpacePtr &, const std::vector<double> &, std::vector<unsigned int>>(),
             nb::arg("space"), nb::arg("cellSizes"), nb::arg("components"))
        .def(nb::init<const ob::StateSpace *, std::vector<unsigned int>>(), nb::arg("space"), nb::arg("components"))
        .def(nb::init<const ob::StateSpacePtr &, std::vector<unsigned int>>(), nb::arg("space"), nb::arg("components"))
    ...
    nb::class_<ob::RealVectorIdentityProjectionEvaluator, ob::ProjectionEvaluator>(m, "RealVectorIdentityProjectionEval"
                                                                                      "uator")
        .def(nb::init<const ob::StateSpace *, const std::vector<double> &>(), nb::arg("space"), nb::arg("cellSizes"))
        .def(nb::init<const ob::StateSpacePtr &, const std::vector<double> &>(), nb::arg("space"), nb::arg("cellSizes"))
