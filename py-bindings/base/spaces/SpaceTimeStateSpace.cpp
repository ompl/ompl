...
void ompl::binding::base::initSpaces_SpaceTimeStateSpace(nb::module_ &m)
{
    nb::class_<ob::SpaceTimeStateSpace, ob::CompoundStateSpace>(m, "SpaceTimeStateSpace")
        .def(nb::init<const ob::StateSpacePtr &, double, double>(), nb::arg("spaceComponent"), nb::arg("vMax") = 1.0,
             nb::arg("timeWeight") = 0.5)
        ...
        .def("distanceTime", &ob::SpaceTimeStateSpace::distanceTime, nb::arg("state1"), nb::arg("state2"))

        .def_static("getStateTime", &ob::SpaceTimeStateSpace::getStateTime, nb::arg("state"))

        .def("setTimeBounds", &ob::SpaceTimeStateSpace::setTimeBounds, nb::arg("lower"), nb::arg("upper"))

        .def("getVMax", &ob::SpaceTimeStateSpace::getVMax)

        .def("setVMax", &ob::SpaceTimeStateSpace::setVMax, nb::arg("vMax"))

        .def("getSpaceComponent", &ob::SpaceTimeStateSpace::getSpaceComponent, nb::rv_policy::reference_internal)

        .def("getTimeComponent", &ob::SpaceTimeStateSpace::getTimeComponent, nb::rv_policy::reference_internal)
