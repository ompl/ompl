...
namespace ompl::binding::base
{
    ...
    void init_Dubins3DMotionValidator(nanobind::module_ &m);
    void init_DubinsMotionValidator(nanobind::module_ &m);
    ...
    void initSamplers_OrderedInfSampler(nanobind::module_ &m);
    void initSamplers_PathLengthDirectInfSampler(nanobind::module_ &m);
    void initSamplers_RejectionInfSampler(nanobind::module_ &m);
    ...
    void initSpaces_HybridStateSpace(nanobind::module_ &m);
    void initSpaces_HybridTimeStateSpace(nanobind::module_ &m);
