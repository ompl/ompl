...
void ompl::binding::base::initSamplers_ConditionalStateSampler(nb::module_ &m)
{
    ...
    nb::class_<ob::ConditionalStateSampler, PyConditionalStateSampler, ob::ValidStateSampler>(m,
        ...
        .def(
            "startMotionPtr",
            [](ob::ConditionalStateSampler &self)
            { return static_cast<PyConditionalStateSampler &>(self).startMotionPtr; })
        .def(
            "setStartMotionPtr",
            [](ob::ConditionalStateSampler &self, ob::ConditionalStateSampler::Motion *motion)
            { static_cast<PyConditionalStateSampler &>(self).startMotionPtr = motion; },
            nb::arg("motion"))
        .def(
            "goalMotions",
        ...
        .def(
            "setSampleOldBatchFlag",
            [](ob::ConditionalStateSampler &self, bool value)
            { static_cast<PyConditionalStateSampler &>(self).sampleOldBatchFlag = value; },
            nb::arg("value"))
