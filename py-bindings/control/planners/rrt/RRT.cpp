...
void ompl::binding::control::initPlannersRrt_RRT(nb::module_ &m)
{
    nb::class_<oc::RRT, ob::Planner>(m, "RRT")
        ...
        .def("setGoalBias", &oc::RRT::setGoalBias, nb::arg("goalBias"))
        .def("getGoalBias", &oc::RRT::getGoalBias)

        .def("setIntermediateStates", &oc::RRT::setIntermediateStates, nb::arg("addIntermediateStates"))
        .def("getIntermediateStates", &oc::RRT::getIntermediateStates)

        // getPlannerData (fills the PlannerData object)
        .def(
            "getPlannerData", [](const oc::RRT &rrt, ob::PlannerData &data) { rrt.getPlannerData(data); },
            nb::arg("data"))
        // set up
