...
void ompl::binding::control::initPlannersLtl_LTLSpaceInformation(nb::module_ &m)
{
    nb::class_<oc::LTLSpaceInformation, oc::SpaceInformation>(m, "LTLSpaceInformation")
        .def(nb::init<const oc::SpaceInformationPtr &, const oc::ProductGraphPtr &>(), nb::arg("si"), nb::arg("prod"))
        ...
        .def("getLowLevelState", nb::overload_cast<ob::State *>(&oc::LTLSpaceInformation::getLowLevelState),
             nb::arg("s"), nb::rv_policy::reference_internal)
        .def("getLowLevelState", nb::overload_cast<const ob::State *>(&oc::LTLSpaceInformation::getLowLevelState),
             nb::arg("s"), nb::rv_policy::reference_internal)
