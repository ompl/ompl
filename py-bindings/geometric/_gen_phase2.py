...
planners = [
    (
        ...
        2,
        "nb::init<const ob::SpaceInformationPtr &>()",
        "si",
        [
    ...
    (
        ...
        [
            ...
            ("setRange", "distance"),
            ("getRange",),
            ("setSelectionRadius", "selectionRadius"),
            ("getSelectionRadius",),
            ("setPruningRadius", "pruningRadius"),
            ("getPruningRadius",),
        ],
    ),
    (
    ...
    (
        ...
        [
            ...
            ("setRange", "distance"),
            ("getRange",),
            ("setMinValidPathFraction", "fraction"),
    ...
    (
        ...
        [
            ...
            ("setRange", "distance"),
            ("getRange",),
            ("setApproximationFactor", "epsilon"),
    ...
    (
        ...
        [
            ...
            ("setRange", "distance"),
            ("getRange",),
            ("setTempChangeFactor", "factor"),
            ("getTempChangeFactor",),
            ("setCostThreshold", "maxCost"),
            ("getCostThreshold",),
            ("setInitTemperature", "initTemperature"),
            ("getInitTemperature",),
            ("setFrontierThreshold", "frontier_threshold"),
            ("getFrontierThreshold",),
            ("setFrontierNodeRatio", "frontierNodeRatio"),
    ...
    (
        ...
        [
            ...
            ("setInitTemperature", "initTemperature"),
            ("getInitTemperature",),
            ("setFrontierThreshold", "frontierThreshold"),
            ("getFrontierThreshold",),
            ("setFrontierNodeRatio", "frontierNodeRatio"),
            ("getFrontierNodeRatio",),
        ],
    ...
    (
        ...
        [
            ...
            ("setOptimumApproxFactor", "optimumApproxFactor"),
            ("getRewiringState",),
            ("setRewiringToOff",),
            ("setRewiringToRadius",),
            ...
            ("getBatchSize",),
            ("setBatchSize", "v"),
            ("setTimeBoundFactorIncrease", "f"),
            ("setInitialTimeBoundFactor", "f"),
            ("setSampleUniformForUnboundedTime", "uniform"),
        ],
    ),
    (
        "rlrt",
        "RLRT",
        "initPlannersRlrt_RLRT",
...
created.append(
    gen_planner(
        "rrt",
        "RRTsharp",
        "initPlannersRrt_RRTsharp",
        "ompl/geometric/planners/rrt/RRTsharp.h",
        2,
        "nb::init<const ob::SpaceInformationPtr &>()",
        "si",
        [],
        parent="og::RRTXstatic",
        clear="&og::RRTXstatic::clear",
        setup="&og::RRTsharp::setup",
    )
)
...
rrtx_methods = [
    ("setGoalBias", "goalBias"),
    ("getGoalBias",),
    ("setInformedSampling", "informedSampling"),
    ("getInformedSampling",),
    ("setSampleRejection", "reject"),
    ("getSampleRejection",),
    ("setNumSamplingAttempts", "numAttempts"),
    ("getNumSamplingAttempts",),
    ("setEpsilon", "epsilon"),
    ("getEpsilon",),
    ("setRange", "distance"),
    ("getRange",),
    ("setRewireFactor", "rewireFactor"),
    ("getRewireFactor",),
    ("setKNearest", "useKNearest"),
    ("getKNearest",),
    ("setUpdateChildren", "val"),
    ("getUpdateChildren",),
    ("setVariant", "variant"),
    ("getVariant",),
    ("setAlpha", "a"),
...
trrtstar_methods = [
    ...
    ("setDelayCC", "delayCC"),
    ("getDelayCC",),
    ("setTreePruning", "prune"),
    ("getTreePruning",),
    ("setPruneThreshold", "pp"),
    ("getPruneThreshold",),
    ("setAdmissibleCostToCome", "admissible"),
...
created.append(
    gen_planner(
        ...
        [],
        parent="og::LazyPRM",
        clear="&og::LazyPRM::clear",
        setup="&og::LazyPRM::setup",
    )
)
