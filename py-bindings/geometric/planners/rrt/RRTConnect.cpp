...
void ompl::binding::geometric::initPlannersRrt_RRTConnect(nb::module_ &m)
{
    ...
    nb::class_<RRTConnect, Planner>(m, "RRTConnect")
        .def(nb::init<const SpaceInformationPtr &, bool>(), nb::arg("si"), nb::arg("addIntermediateStates") = false)
        .def("getIntermediateStates", &RRTConnect::getIntermediateStates)
        .def("setIntermediateStates", &RRTConnect::setIntermediateStates, nb::arg("addIntermediateStates"))
        .def("setRange", &RRTConnect::setRange, nb::arg("distance"))
        ...
        .def("getPlannerData", &RRTConnect::getPlannerData, nb::arg("data"));
}
