...
void ompl::binding::multilevel::init_BundleSpace(nb::module_ &m)
{
    nb::class_<om::BundleSpace, ob::Planner>(m, "BundleSpace")
        ...
        .def(
            "sampleBundle", [](om::BundleSpace &self, ob::State *xRandom) { self.sampleBundle(xRandom); },
            nb::arg("xRandom"))
        ...
        .def(
            "project", [](const om::BundleSpace &self, const ob::State *xBundle, ob::State *xBase)
            { self.project(xBundle, xBase); }, nb::arg("xBundle"), nb::arg("xBase"))
        .def(
            "lift", [](const om::BundleSpace &self, const ob::State *xBase, ob::State *xBundle)
            { self.lift(xBase, xBundle); }, nb::arg("xBase"), nb::arg("xBundle"))
